        ...
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-4 overflow-x-auto scrollbar-hide nav-scroll whitespace-nowrap pl-4">
            ...
            <Link
              ...
              className="text-indigo-200/50 hover:text-white transition-colors text-sm flex-shrink-0"
            >
              Learn <span className="text-emerald-400 text-[10px] ml-0.5">new</span>
            </Link>
            <Link
              href="/reports"
              className="text-indigo-200/50 hover:text-white transition-colors text-sm flex-shrink-0"
            >
              Reports <span className="text-emerald-400 text-[10px] ml-0.5">new</span>
            </Link>
            <Link
              href="/charts"
              className="text-indigo-200/50 hover:text-white transition-colors text-sm flex-shrink-0"
            ...
            <Link
              href="/tarot"
              className="text-white transition-colors text-sm flex-shrink-0"
            >
              Tarot <span className="text-emerald-400 text-[10px] ml-0.5">new</span>
            </Link>
            {!hasBirthData && (
              <Link
                href="/birth-details"

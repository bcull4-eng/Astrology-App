...
export const reports: Record<ReportSlug, ReportDefinition> = {
  ...
  'past-life-karma': {
    ...
    description:
      'A profound 4,500+ word exploration of your karmic patterns, past life themes, and soul purpose. Discover what your chart reveals about lessons carried from previous incarnations and your evolutionary path in this lifetime.',
    price: 29,
    wordCount: '4,500-5,500 words',
    deliveryTime: 'Instant',
    icon: '🌙',
  ...
  'financial-potential': {
    ...
    description:
      'A comprehensive 4,500+ word analysis of your financial potential based on your birth chart. Discover your natural money-making abilities, investment style, career prosperity indicators, and optimal timing for financial decisions.',
    price: 29,
    wordCount: '4,500-5,500 words',
    deliveryTime: 'Instant',
    icon: '💎',
  ...
  'partner-compatibility': {
    ...
    description:
      'An extensive 5,000+ word synastry and composite chart analysis exploring every dimension of your relationship. From emotional bonds to long-term potential, discover the cosmic blueprint of your partnership.',
    price: 29,
    wordCount: '5,000-6,000 words',
    deliveryTime: 'Instant',
    icon: '💑',

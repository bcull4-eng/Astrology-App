...
const ReadingTypeCard = dynamic(() => import('@/components/tarot/reading-type-card').then(mod => ({ default: mod.ReadingTypeCard })), {
  loading: () => <div className="h-32 bg-slate-800/40 rounded-2xl animate-pulse" />
})

const DeckSpread = dynamic(() => import('@/components/tarot/deck-spread').then(mod => ({ default: mod.DeckSpread })), {
...
const ReadingResult = dynamic(() => import('@/components/tarot/reading-result').then(mod => ({ default: mod.ReadingResult })), {
  loading: () => <div className="h-64 flex items-center justify-center"><div className="w-8 h-8 border-2 border-indigo-500 border-t-transparent rounded-full animate-spin" /></div>
})

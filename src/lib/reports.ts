...
export const reports: Record<ReportSlug, ReportDefinition> = {
  ...
  'monthly-forecast': {
    ...
    description:
      'A detailed 4,000+ word guide to your upcoming month with week-by-week breakdowns, daily energy patterns, optimal timing for activities, and personalized guidance based on your birth chart.',
    price: 0,
    wordCount: '4,000-5,000 words',
    deliveryTime: 'Instant',
    icon: '📅',

    ...
    <div className="min-h-screen bg-[#1a1a2e] relative overflow-x-hidden">
      ...
      <header className="border-b border-indigo-500/10 bg-[#1a1a2e]/80 backdrop-blur-md relative z-10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <Link
            href="/settings"
            className="text-indigo-200/50 hover:text-white transition-colors text-sm md:hidden"
          >
            Account
          </Link>
        </div>
        ...
        <div className="overflow-x-auto scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch' }}>
          <nav className="flex items-center gap-4 px-4 pb-3 whitespace-nowrap min-w-max">
            ...
            <Link
              href="/settings"
              className="text-indigo-200/50 hover:text-white transition-colors text-sm hidden md:block"
            >
              Account
            </Link>
            <Link
